...
public class TikaUtil {
    public String isFileValid(MultipartFile file, String type,Long size) {
        if (file.isEmpty()) {
            return "文件是空的";
        }
        Tika tika = new Tika();
    ...
    public String isVideoValid(MultipartFile file,String title) {
    ...
    public String isImageValid(MultipartFile file) {
